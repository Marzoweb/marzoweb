        ...
        <div className="min-h-screen bg-gray-50/50 py-20 px-6">
            <div className="container mx-auto max-w-4xl">
                ...
                >
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">PDF to Excel Converter</h1>
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        Extract data tables from your PDF documents and convert them into formatted Excel spreadsheets.
                    </p>
                </motion.div>
                                ...
                                {file ? (
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 mt-2">PDF documents up to 10MB</p>
                                        </div>
                                    </div>
                                )}
                            </div>
